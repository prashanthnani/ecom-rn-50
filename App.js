...
import SubCatList from "./components/subCategories/SubCatList";
import SubCatListItem from "./components/subCatListItem/SubCatListItem";

import ProductDetails from "./components/products/ProductDetails";
import ProductImageDetails from "./components/products/ProductImageDetails";
...
function onMainScreen(){
 if(prevGetStateForActionHomeStack== 'SplashPage'){
   return false;
 } else{
   return true;
 }
...
const Drawer = DrawerNavigator(
      {
        ...
        SubCatList : {screen : SubCatList},
        SubCatListItem : {screen : SubCatListItem},
...
const AppNavigator = StackNavigator(
  {
        ...
        ProductImageDetails : {screen : ProductImageDetails},
        Basket : {screen : Basket}
    },
    {
