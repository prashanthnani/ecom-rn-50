...
import { LOAD_PRODUCTS, FETCH_PRODUCTS,DELETE_PRODUCTS } from '../actions/actionTypes';
...
const productsReducer = (state = dataState, action) => {
    switch (action.type) {
        case LOAD_PRODUCTS:
        ...
        case DELETE_PRODUCTS:
            ...
            state = Object.assign({}, state, { products: products });
            return state;
        default:
            return state;
    }
